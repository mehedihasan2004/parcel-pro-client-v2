    ...
    return (
        ...
        <Box sx={{
          ...
          <Grid container>
              ...
              Leaders In The <span style={{color:'rgb(245, 152, 66)'}}>Logistics Services</span>
              </Typography>
              ...
              <Box style={{display: 'flex', gap: '10px', margin: '20px'}}>
                  ...
                  <div>
                    ...
                    <h6>By <span style={{color:'rgb(245, 152, 66)'}}>James Moe</span></h6>
                    <h6>Chief Operating Officer</h6>
                  </div>
              </Box>
              </Grid>
              <Grid item xs={12} md={6} lg={6} style={{background: 'white'}}>
                 <Box sx={{display: 'flex', gap: '10px', margin: '20px', border: '1px solid black', padding: '10px', '&:hover':{backgroundColor: 'rgb(245, 152, 66)'} }}>
